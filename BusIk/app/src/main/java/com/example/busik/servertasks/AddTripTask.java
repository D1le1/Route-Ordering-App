...
public class AddTripTask extends AsyncTask<String,Void,String> {
    ...
    public AddTripTask(Context context) {
    ...
    protected String doInBackground(String... strings) {
        String request = "ADD--TRIP--" + strings[0] + "--" + strings[1] + "--" + strings[2] + "--" + strings[3];
        try {
    ...
    protected void onPostExecute(String response) {
        ...
        if(response != null) {
            ...
            {
                error.setText("Рейс не был добавлен. Возможно такой рейс уже существует");
